...
class DefaultController extends Controller {
	...
	public function homeAction($title) {
		...
		return $this->render('OnlinesoaptestBundle:Default:home.html.twig', array('title' => $title, 'active' => 'home', 'SOAP_1_1' => SOAP_1_1, 'SOAP_1_2' => SOAP_1_2, 'SOAP_RPC' => SOAP_RPC, 'SOAP_DOCUMENT' => SOAP_DOCUMENT, 'SOAP_ENCODED' => SOAP_ENCODED, 'SOAP_LITERAL' => SOAP_LITERAL, 'HTTP_HOST' => 'onlinesoaptest', 'DOMAIN_NAME' => 'onlinesoaptest' ));
	
	}

	public function thumbnailsAction( $title ) {
	
		return $this->render('OnlinesoaptestBundle:Default:thumbnails.html.twig', array( 'title' => $title, 'active' => 'photos' ));
		 	 
	}
	
	public function photosAction($title, $name) {

		return $this->render('OnlinesoaptestBundle:Default:photos.html.twig', array( 'title' => $title, 'active' => 'photos' ) );
	
	}
	
    public function aboutAction($title) {
    	 
    	return $this->render('OnlinesoaptestBundle:Default:about.html.twig', array( 'title' => $title, 'active' => 'about' ));
    	 
    }

    public function blogAction($title) {
   	
    	return $this->render('OnlinesoaptestBundle:Default:blog.html.twig', array( 'title' => $title, 'active' => 'blog' ));
    	 
    }

    public function contactAction($title) {
    	 
    	return $this->render('OnlinesoaptestBundle:Default:contact.html.twig', array( 'title' => $title, 'active' => 'contact' ));
